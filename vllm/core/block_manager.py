...
class BlockSpaceManager:
    ...
    def __init__(
        ...
        self.cpu_only = num_gpu_blocks == 0
        ...
        self.watermark_blocks = int(watermark * (num_gpu_blocks if not self.cpu_only else num_cpu_blocks))
